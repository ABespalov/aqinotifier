...
import "github.com/ABespalov/aqinotifier/internal/config"
...
func (ctx *RequestContext) Resolve(key string, args ...interface{}) string {
	return ctx.Bot.Resolve(key, args...)
}
