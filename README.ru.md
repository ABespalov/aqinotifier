...
- **Задержки уведомлений (lazy)** — фильтрация частых повторяющихся уведомлений на границах зон AQI за счет задержки оповещения до тех пор, пока новый уровень не продержится стабильно N измерений подряд (настраивается отдельно для роста и спада)
